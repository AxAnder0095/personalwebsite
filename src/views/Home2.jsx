                                    ...
                                    <div className={'center-projects-container'}>
                                        ...
                                        <div className={'home2-projects-grid'}>
                                            ...
                                            <div className={'home2-projects-right'}>
                                                <Link to={'https://github.com/AxAnder0095/restapipractice'} className={'home2-project-link'}>
                                                    <div className={'picture-box'}>
                                                        <img src={showroom} alt={'some image'} />
                                                    </div>
                                                    <div className={'text-box'}>
                                                        <p className={'home2-project-title'}>Vehicle Showroom</p>
                                                        <p className={'home2-project-desc'}>MERN tech stacked used in creation of a vehicle showroom where you can browse,
                                                            edit, add and delete vehicles. Nodejs used for server-side logic and MongoDB for scalable, document based data storage. 
                                                        </p>
                                                    </div>
                                                </Link>
